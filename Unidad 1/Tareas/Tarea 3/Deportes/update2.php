        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="registros2.php" class="btn btn-info add-new"><i class="fa fa-arrow-left"></i>Regresar</a>
                    </div>
                </div>
            </div>
            <?php
            ...
            $id = $_GET['id'];
            $sql = "SELECT * FROM basquetbol where id='$id'";
            ...
            if (isset($_POST) && !empty($_POST)) {
                ...
                $sql = "UPDATE basquetbol SET id='$id', nombre='$nombre', posicion='$posicion', carrera='$carrera', correo='$correo' WHERE id=$id";
                ...
                header('Location: update2.php?id='.$id);
