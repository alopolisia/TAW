<?php
    ...
    class Database{
        ...
        public function valida_usuario_bd($usuario, $contra){
		    $query = "SELECT id FROM usuarios WHERE usuario='$usuario' AND contra='$contra' LIMIT 1";

    		$resultado = mysqli_query($this->con,$query) or die('Error al ejecutar la consulta');
